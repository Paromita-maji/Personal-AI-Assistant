...
**Option 1 (For a deployed project where the user needs to input a key):**

Visit the link, enter your Gemini API key when prompted, and start chatting!

**Option 2 (For local setup where the user needs to modify a file):**

Clone this repository.
Open the script.js and replace the placeholder with your Gemini API key.
Open index.html in your browser and enjoy chatting!

**Option 3 (More generic for local setup):**
